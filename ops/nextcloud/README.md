...
2. [main-users.yaml](/Users/virgil/Dev/rita-v4/ops/nextcloud/main-users.yaml)
...
4. `main-users.yaml` defines the canonical 1Password vault + item mapping for primary Nextcloud users and intended role (`admin` or `user`).
