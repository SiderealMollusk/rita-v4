...
As of this update, `ops-brain` successfully installed and deployed `newt` into the local k3s cluster.
...
4. The `ops-brain` services phase completed `10-install-newt.sh`
