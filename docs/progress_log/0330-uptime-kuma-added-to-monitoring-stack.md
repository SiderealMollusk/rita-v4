...
As of this update, `ops-brain` monitoring deployment now includes Uptime Kuma as part of the standard monitoring service lane.

What changed:
1. the `ops-brain` monitoring install script now deploys:
   - `uptime-kuma`
