...
3. `scripts/2-ops/ops-brain/02-services/00-run-all.sh`
...
2. `scripts/2-ops/ops-brain/11-install-monitoring-stack.sh`
3. `scripts/2-ops/ops-brain/12-verify-monitoring-stack.sh`
4. `docs/plans/0140-ops-brain-monitoring-and-pangolin-access.md`
