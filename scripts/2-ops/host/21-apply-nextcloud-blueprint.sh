...
echo "[INFO] Applying Nextcloud Pangolin blueprint from Mac host"
echo "[INFO] Blueprint file: $BLUEPRINT_FILE"
echo "[INFO] Blueprint name: $BLUEPRINT_NAME"
echo "[INFO] Site identifier: $SITE_IDENTIFIER"
echo "[INFO] Target backend: nextcloud-edge.workload.svc.cluster.local:8080"
...
echo "[OK] Nextcloud blueprint apply command completed"
echo "[INFO] Verify in Pangolin that app.virgil.info now targets nextcloud-edge.workload.svc.cluster.local:8080"
